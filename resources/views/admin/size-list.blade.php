            ...
            <article class="itemlist">
                <div class="row align-items-center">
                    ...
                    <div class="col-lg-6 col-sm-6 col-6 col-action text-end">
                        ...
                        @if ($show['status']==1)
                        <a href="{{url('admin/size/status/0')}}/{{$show['id']}}" class="btn btn-sm font-sm rounded btn-brand"> <i class="material-icons md-edit"></i> Inctive </a>
                        @elseif($show['status']==0)
                        <a href="{{url('admin/size/status/1')}}/{{$show['id']}}" class="btn btn-sm font-sm rounded btn-brand"> <i class="material-icons md-edit"></i> Active </a>
                        @endif
