                    ...
                    <table class="table table-wishlist">
                        ...
                        <tbody>
                            ...
                            <tr class="pt-30" id="AdToCartBox{{$show->attr_id}}">
                                ...
                                <td class="image product-thumbnail pt-40"><img src="{{asset('storage/media/'.$show->attr_image)}}" alt="#"></td>
                                <td class="product-des product-name">
                                    <h6 class="mb-5"><a class="product-name mb-10 text-heading" target="_blank" href="{{url('frontend/product/'.$show->slug)}}">{{$show->name}}</a></h6>
                                ...
                                <td class="text-center detail-info" data-title="Stock">
                                    <div class="detail-extralink mr-15">
                                        <div class="detail-qty border radius">
                                            ...
                                            <input type="number" onchange="updateQty('{{$show->products_id}}','{{$show->size}}','{{$show->color}}','{{$show->attr_id}}','{{$show->price}}')"  name="qty" id="qty{{$show->attr_id}}" class="qty-val" value="{{$show->qty}}" min="1">
