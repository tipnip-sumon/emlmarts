                            ...
                            <div class="detail-gallery">
                                ...
                                <!-- THUMBNAILS -->
                                        ...
                                        <div class="slider-nav-thumbnails">
                                                ...
                                                <div><img src="{{asset('storage/media/'.$list->images)}}" height="50px" width="50px" alt="product image" /></div>
                                                @endforeach
                                        </div>
                            ...
                            <div class="detail-info pr-30 pl-30">
                                ...
                                <div class="clearfix product-price-cover">
                                    <div class="product-price primary-color float-left">
                                            <span class="current-price text-brand">${{$product_attr[$product[0]->id][0]->mrp}}</span>
                                            <span>
                                    ...
                                    <div class="product-cart-wrap hover-up">
                                        ...
                                        <div class="product-img-action-wrap">
                                            <div class="product-img product-img-zoom">
                                                <a href="shop-product-right.html" tabindex="0">
                                                    <img class="default-img" src="{{asset('storage/media/'.$list->image)}}" alt="" />
                                        ...
                                        <div class="product-content-wrap">
                                            ...
                                            <div class="product-price">
                                                <span>${{$related_product_attr[$list->id][0]->mrp}} </span>
                                                <span class="old-price">${{$related_product_attr[$list->id][0]->price}}</span>
                                            </div>
                                        </div>
                                        @endforeach
                                    </div>
